...
const BithotelChild = artifacts.require('BithotelChild');

contract('BithotelChild', function (accounts) {
  ...
  it('requires a non-zero cap', async function () {
    await expectRevert(
      BithotelChild.new(name, symbol, initialSupply, new BN(0), { from: initialHolder }), 'ERC20Capped: cap is 0',
    );
  });

  beforeEach(async function () {
    this.token = await BithotelChild.new(name, symbol, initialSupply, initialSupply);
  });
